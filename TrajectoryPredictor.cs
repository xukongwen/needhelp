...
public class TrajectoryPredictor : MonoBehaviour {
    ...
    //這下面是預測軌道，根據自己給的力來預測軌道，應該招手從這裡修改和學習

    /// <summary>
    /// 每次預測迭代的事件，可以用來寫自己的受力（除了unity自帶的重力之外).
    /// </summary>
    /// <param name="currentIterationVel">每次迭代的自定義速度.</param>
    /// <param name="currentIterationPos">每次迭代的自定義位置.</param>
    /// <param name="tpInstance">TPClass的實例.</param>
